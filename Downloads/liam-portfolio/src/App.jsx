  ...
  const projectCards = [
    {
      ...
      text: 'Structured onboarding materials, learning paths, and support resources designed to improve time to proficiency.',
    },
    {
      title: 'Job Aids and Documentation',
      text: 'Clear step-by-step resources that reinforce workflows, reduce confusion, and support user adoption.',
    },
    {
      title: 'Facilitated Learning Sessions',
      text: 'Instructor-led training focused on helping learners apply technical processes with confidence.',
    },
  ]
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section id="about" className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1fr,1.2fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-sky-300">About Me</p>
          ...
          <div className="space-y-5 text-base leading-8 text-slate-300">
            <p>
              My work centers on helping people learn new systems and processes in a way that feels practical,
              supportive, and easy to apply. I bring a blend of instructional design, facilitation, and
              learner-focused communication to every project.
            </p>
            <p>
              At Verdtek, I focus on creating training materials and learning experiences that support user
              adoption, process understanding, and day-to-day performance. My teaching background strengthened
              my ability to engage learners, simplify complex ideas, and design instruction that meets people
              where they are.
            </p>
          </div>
        </div>
      ...
      <section id="experience" className="border-y border-white/10 bg-slate-900/60">
        <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-lg">
              <p className="text-sm font-medium text-slate-400">Teaching Foundation</p>
              <h3 className="mt-2 text-2xl font-bold text-white">Teaching and Facilitation Experience</h3>
              <ul className="mt-6 space-y-4 text-sm leading-6 text-slate-300">
      ...
      <section id="work" className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Featured work and sample focus areas
            </h2>
          </div>
          <p className="max-w-xl text-sm leading-6 text-slate-400">
            Replace these cards with real projects, screenshots, PDFs, training decks, e-learning samples, or
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {projectCards.map((project) => (
            ...
            >
              <div className="mb-5 rounded-2xl border border-dashed border-white/10 bg-slate-900/80 p-10 text-center text-sm font-medium text-slate-400">
                Project Preview
              </div>
      ...
      <section className="border-y border-white/10 bg-slate-900/70">
        <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-sky-300">What I Bring</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {skills.map((skill) => (
                <div key={skill} className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-200">
                  {skill}
                </div>
              ))}
            </div>
      ...
      <section id="contact" className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-10 text-center shadow-lg">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">Let’s connect</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-300">
            I’m interested in opportunities in instructional design, training, enablement, and learning
            experience development.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm font-medium text-slate-200">
            <span className="rounded-full border border-white/10 bg-slate-900/80 px-4 py-2">your.email@example.com</span>
            <span className="rounded-full border border-white/10 bg-slate-900/80 px-4 py-2">LinkedIn profile</span>
            <span className="rounded-full border border-white/10 bg-slate-900/80 px-4 py-2">Portfolio samples available on request</span>
          </div>
        </div>
      </section>
    </div>
